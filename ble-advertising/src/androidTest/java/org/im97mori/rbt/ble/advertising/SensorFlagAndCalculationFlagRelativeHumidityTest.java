...
public class SensorFlagAndCalculationFlagRelativeHumidityTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_relativeHumidity002() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity003() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity004() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity005() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity006() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity007() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity008() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity009() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity010() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity011() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity012() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity013() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity014() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity015() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity016() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
    ...
    public void test_relativeHumidity017() {
        ...
        data1[ 2] = (byte) 0x00; // Temperature flag
        data1[ 3] = (byte) 0x00; // Temperature flag
        data1[ 4] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER & 0xff); // Relative humidity flag
        data1[ 5] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER >> 8) & 0xff); // Relative humidity flag
        data1[ 6] = (byte) 0x00; // Ambient light flag
        data1[ 7] = (byte) 0x00; // Ambient light flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Barometric pressure flag
