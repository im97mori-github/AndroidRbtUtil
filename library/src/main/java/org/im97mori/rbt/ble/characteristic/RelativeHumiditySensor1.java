...
public class RelativeHumiditySensor1 extends AbstractCharacteristic implements Parcelable {
    ...
    public static final Creator<RelativeHumiditySensor1> CREATOR = new Creator<RelativeHumiditySensor1>() {
         ...
         */
        @Override
        public RelativeHumiditySensor1 createFromParcel(Parcel in) {
     ...
     */
    public RelativeHumiditySensor1(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private RelativeHumiditySensor1(Parcel in) {
