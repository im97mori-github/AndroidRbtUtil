...
public class AccelerationMemoryData9 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData9> CREATOR = new ByteArrayCreater<AccelerationMemoryData9>() {
         ...
         */
        @Override
        public AccelerationMemoryData9 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData9 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData9(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData9(Parcel in) {
