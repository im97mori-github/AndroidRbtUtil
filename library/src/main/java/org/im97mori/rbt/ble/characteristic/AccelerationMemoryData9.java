...
public class AccelerationMemoryData9 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData9> CREATOR = new ByteArrayCreater<AccelerationMemoryData9>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData9 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData9(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData9[] newArray(int size) {
            return new AccelerationMemoryData9[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData9 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData9(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData9(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData9(@NonNull Parcel in) {
