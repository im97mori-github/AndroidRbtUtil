...
/**
 * 2.6.1 Event pattern Temperature (Characteristics UUID: 0x5211)
 */
@SuppressWarnings("WeakerAccess")
public class TemperatureSensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<TemperatureSensor1> CREATOR = new Creator<TemperatureSensor1>() {
