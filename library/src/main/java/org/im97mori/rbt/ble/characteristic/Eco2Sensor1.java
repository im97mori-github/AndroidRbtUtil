...
/**
 * 2.6.1 Event pattern eCO2 1 (Characteristics UUID: 0x521D)
 */
@SuppressWarnings("WeakerAccess")
public class Eco2Sensor1 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<Eco2Sensor1> CREATOR = new ByteArrayCreater<Eco2Sensor1>() {
        ...
        @Override
        @NonNull
        public Eco2Sensor1 createFromParcel(@NonNull Parcel in) {
            return new Eco2Sensor1(in);
        }
        ...
        @Override
        @NonNull
        public Eco2Sensor1[] newArray(int size) {
            return new Eco2Sensor1[size];
        }
        ...
        @Override
        @NonNull
        public Eco2Sensor1 createFromByteArray(@NonNull byte[] values) {
            BluetoothGattCharacteristic bluetoothGattCharacteristic = new BluetoothGattCharacteristic(ECO2_SENSOR_1_CHARACTERISTIC, 0, 0);
            bluetoothGattCharacteristic.setValue(values);
            return new Eco2Sensor1(bluetoothGattCharacteristic);
        }
     ...
     *
     * @param bluetoothGattCharacteristic Characteristics UUID: 0x521D
     */
    public Eco2Sensor1(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     */
    public Eco2Sensor1(int eventEnableDisable, int simpleThresholdUpperLimit1, int simpleThresholdUpperLimit2, int simpleThresholdLowerLimit1, int simpleThresholdLowerLimit2, int changeThresholdRise1, int changeThresholdRise2, int changeThresholdDecline1, int changeThresholdDecline2) {
     ...
     * @param in Parcel
     */
    private Eco2Sensor1(@NonNull Parcel in) {
    ...
    /**
     * @return Simple threshold [upper limit] 1(ppm)
     */
    public double getSimpleThresholdUpperLimit1Ppm() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Simple threshold [upper limit] 2(ppm)
     */
    public double getSimpleThresholdUpperLimit2Ppm() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 1(ppm)
     */
    public double getSimpleThresholdLowerLimit1Ppm() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 2(ppm)
     */
    public double getSimpleThresholdLowerLimit2Ppm() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 1(ppm)
     */
    public double getChangeThresholdRise1Ppm() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 2(ppm)
     */
    public double getChangeThresholdRise2Ppm() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 1(ppm)
     */
    public double getChangeThresholdDecline1Ppm() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_ECO2_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 2(ppm)
     */
    public double getChangeThresholdDecline2Ppm() {
        return mChangeThresholdDecline2 * EVENT_THRESHOLD_ECO2_UNIT;
    }
