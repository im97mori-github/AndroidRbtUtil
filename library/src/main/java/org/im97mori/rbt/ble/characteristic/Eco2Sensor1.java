...
public class Eco2Sensor1 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<Eco2Sensor1> CREATOR = new ByteArrayCreater<Eco2Sensor1>() {
         ...
         */
        @Override
        public Eco2Sensor1 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public Eco2Sensor1 createFromByteArray(byte[] values) {
     ...
     */
    public Eco2Sensor1(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
