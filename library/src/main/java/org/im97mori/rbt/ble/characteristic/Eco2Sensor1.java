...
/**
 * 2.6.1 Event pattern eCO2 (Characteristics UUID: 0x521D)
 */
@SuppressWarnings("WeakerAccess")
public class Eco2Sensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<Eco2Sensor1> CREATOR = new Creator<Eco2Sensor1>() {
