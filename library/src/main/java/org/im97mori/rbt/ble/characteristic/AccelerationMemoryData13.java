...
public class AccelerationMemoryData13 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData13> CREATOR = new ByteArrayCreater<AccelerationMemoryData13>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData13 createFromParcel(@NonNull Parcel in) {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData13 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData13(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData13(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData13(@NonNull Parcel in) {
