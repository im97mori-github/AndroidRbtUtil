...
/**
 * 2.6.1 Event pattern eTVOC (Characteristics UUID: 0x521B)
 */
@SuppressWarnings("WeakerAccess")
public class EtvocSensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<EtvocSensor1> CREATOR = new Creator<EtvocSensor1>() {
