...
public class AccelerationMemoryData12 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData12> CREATOR = new ByteArrayCreater<AccelerationMemoryData12>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData12 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData12(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData12[] newArray(int size) {
            return new AccelerationMemoryData12[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData12 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData12(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData12(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData12(@NonNull Parcel in) {
