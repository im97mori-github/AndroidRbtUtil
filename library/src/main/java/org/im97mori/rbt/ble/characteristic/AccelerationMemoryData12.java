...
public class AccelerationMemoryData12 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData12> CREATOR = new ByteArrayCreater<AccelerationMemoryData12>() {
         ...
         */
        @Override
        public AccelerationMemoryData12 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData12 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData12(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData12(Parcel in) {
