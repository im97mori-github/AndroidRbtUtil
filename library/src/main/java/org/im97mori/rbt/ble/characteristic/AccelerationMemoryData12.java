...
public class AccelerationMemoryData12 extends AbstractCharacteristic implements Parcelable {
     ...
     * @see Creator
     */
    public static final Creator<AccelerationMemoryData12> CREATOR = new Creator<AccelerationMemoryData12>() {
