...
public class AccelerationMemoryData8 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData8> CREATOR = new ByteArrayCreater<AccelerationMemoryData8>() {
         ...
         */
        @Override
        public AccelerationMemoryData8 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData8 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData8(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData8(Parcel in) {
