...
public class AccelerationMemoryData8 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData8> CREATOR = new ByteArrayCreater<AccelerationMemoryData8>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData8 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData8(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData8[] newArray(int size) {
            return new AccelerationMemoryData8[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData8 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData8(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData8(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData8(@NonNull Parcel in) {
