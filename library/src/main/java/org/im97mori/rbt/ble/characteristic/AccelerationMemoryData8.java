...
public class AccelerationMemoryData8 extends AbstractCharacteristic implements Parcelable {
     ...
     * @see Creator
     */
    public static final Creator<AccelerationMemoryData8> CREATOR = new Creator<AccelerationMemoryData8>() {
