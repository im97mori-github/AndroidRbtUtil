...
/**
 * 2.6.1 Event pattern Temperature (Characteristics UUID: 0x5219)
 */
@SuppressWarnings("WeakerAccess")
public class SoundNoiseSensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<SoundNoiseSensor1> CREATOR = new Creator<SoundNoiseSensor1>() {

        /**
         * {@inheritDoc}
         */
        @Override
        public SoundNoiseSensor1 createFromParcel(Parcel in) {
     ...
     */
    public SoundNoiseSensor1(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private SoundNoiseSensor1(Parcel in) {
