...
/**
 * 2.6.1 Event pattern Heat stroke 1 (Characteristics UUID: 0x5221)
 */
@SuppressWarnings("WeakerAccess")
public class HeatStrokeSensor1 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<HeatStrokeSensor1> CREATOR = new ByteArrayCreater<HeatStrokeSensor1>() {
     ...
     */
    public HeatStrokeSensor1(int eventEnableDisable, int simpleThresholdUpperLimit1, int simpleThresholdUpperLimit2, int simpleThresholdLowerLimit1, int simpleThresholdLowerLimit2, int changeThresholdRise1, int changeThresholdRise2, int changeThresholdDecline1, int changeThresholdDecline2) {
    ...
    /**
     * @return Simple threshold [upper limit] 1(degC)
     */
    public double getSimpleThresholdUpperLimit1DegC() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Simple threshold [upper limit] 2(degC)
     */
    public double getSimpleThresholdUpperLimit2DegC() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 1(degC)
     */
    public double getSimpleThresholdLowerLimit1DegC() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 2(degC)
     */
    public double getSimpleThresholdLowerLimit2DegC() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 1(degC)
     */
    public double getChangeThresholdRise1DegC() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 2(degC)
     */
    public double getChangeThresholdRise2DegC() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 1(degC)
     */
    public double getChangeThresholdDecline1DegC() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 2(degC)
     */
    public double getChangeThresholdDecline2DegC() {
        return mChangeThresholdDecline2 * EVENT_THRESHOLD_HEAT_STROKE_UNIT;
    }
