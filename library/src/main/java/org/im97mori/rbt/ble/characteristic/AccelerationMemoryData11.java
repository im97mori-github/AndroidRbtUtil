...
public class AccelerationMemoryData11 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData11> CREATOR = new ByteArrayCreater<AccelerationMemoryData11>() {
         ...
         */
        @Override
        public AccelerationMemoryData11 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData11 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData11(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData11(Parcel in) {
