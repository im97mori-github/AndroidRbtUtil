...
public class AccelerationMemoryData11 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData11> CREATOR = new ByteArrayCreater<AccelerationMemoryData11>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData11 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData11(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData11[] newArray(int size) {
            return new AccelerationMemoryData11[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData11 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData11(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData11(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData11(@NonNull Parcel in) {
