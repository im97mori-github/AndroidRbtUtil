...
public class AccelerationMemoryData11 extends AbstractCharacteristic implements Parcelable {
     ...
     * @see Creator
     */
    public static final Creator<AccelerationMemoryData11> CREATOR = new Creator<AccelerationMemoryData11>() {
