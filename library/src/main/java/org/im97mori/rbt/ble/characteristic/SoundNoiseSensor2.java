...
/**
 * 2.6.2 Event pattern Sound noise 2 (Characteristics UUID: 0x521A)
 */
@SuppressWarnings("WeakerAccess")
public class SoundNoiseSensor2 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<SoundNoiseSensor2> CREATOR = new ByteArrayCreater<SoundNoiseSensor2>() {
    ...
    /**
     * @return Average value threshold [upper](dB)
     */
    public double getAverageValueThresholdUpperDb() {
        return mAverageValueThresholdUpper * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Average value threshold [lower](dB)
     */
    public double getAverageValueThresholdLowerDb() {
        return mAverageValueThresholdLower * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Peak to Peak threshold [upper](dB)
     */
    public double getPeakToPeakThresholdUpperDb() {
        return mPeakToPeakThresholdUpper * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Peak to Peak threshold [lower](dB)
     */
    public double getPeakToPeakThresholdLowerDb() {
        return mPeakToPeakThresholdLower * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Interval difference threshold [upper](dB)
     */
    public double getIntervalDifferenceThresholdUpperDb() {
        return mIntervalDifferenceThresholdUpper * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Interval difference threshold [lower](dB)
     */
    public double getIntervalDifferenceThresholdLowerDb() {
        return mIntervalDifferenceThresholdLower * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Base difference threshold [upper](dB)
     */
    public double getBaseDifferenceThresholdUpperDb() {
        return mBaseDifferenceThresholdUpper * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
    ...
    /**
     * @return Base difference threshold [lower](dB)
     */
    public double getBaseDifferenceThresholdLowerDb() {
        return mBaseDifferenceThresholdLower * EVENT_THRESHOLD_SOUND_NOISE_UNIT;
    }
