...
/**
 * 2.6.2 Event pattern Sound noise (Characteristics UUID: 0x521A)
 */
@SuppressWarnings("WeakerAccess")
public class SoundNoiseSensor2 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<SoundNoiseSensor2> CREATOR = new Creator<SoundNoiseSensor2>() {
