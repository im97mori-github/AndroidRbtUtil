...
/**
 * 2.6.2 Event pattern Ambient light (Characteristics UUID: 0x5216)
 */
@SuppressWarnings("WeakerAccess")
public class AmbientLightSensor2 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<AmbientLightSensor2> CREATOR = new Creator<AmbientLightSensor2>() {

        /**
         * {@inheritDoc}
         */
        @Override
        public AmbientLightSensor2 createFromParcel(Parcel in) {
     ...
     */
    public AmbientLightSensor2(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AmbientLightSensor2(Parcel in) {
