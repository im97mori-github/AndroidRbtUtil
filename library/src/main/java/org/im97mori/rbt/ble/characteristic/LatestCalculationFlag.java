...
public class LatestCalculationFlag extends AbstractCharacteristic implements Parcelable {
    ...
    public static final Creator<LatestCalculationFlag> CREATOR = new Creator<LatestCalculationFlag>() {
         ...
         */
        @Override
        public LatestCalculationFlag createFromParcel(Parcel in) {
     ...
     */
    public LatestCalculationFlag(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private LatestCalculationFlag(Parcel in) {
