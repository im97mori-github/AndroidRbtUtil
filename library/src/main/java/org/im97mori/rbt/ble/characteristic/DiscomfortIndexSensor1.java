...
public class DiscomfortIndexSensor1 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<DiscomfortIndexSensor1> CREATOR = new ByteArrayCreater<DiscomfortIndexSensor1>() {
         ...
         */
        @Override
        public DiscomfortIndexSensor1 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public DiscomfortIndexSensor1 createFromByteArray(byte[] values) {
     ...
     */
    public DiscomfortIndexSensor1(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private DiscomfortIndexSensor1(Parcel in) {
