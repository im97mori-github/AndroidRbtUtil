...
/**
 * 2.6.1 Event pattern Discomfort index 1 (Characteristics UUID: 0x521F)
 */
@SuppressWarnings("WeakerAccess")
public class DiscomfortIndexSensor1 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<DiscomfortIndexSensor1> CREATOR = new ByteArrayCreater<DiscomfortIndexSensor1>() {
        ...
        @Override
        @NonNull
        public DiscomfortIndexSensor1 createFromParcel(@NonNull Parcel in) {
            return new DiscomfortIndexSensor1(in);
        }
        ...
        @Override
        @NonNull
        public DiscomfortIndexSensor1[] newArray(int size) {
            return new DiscomfortIndexSensor1[size];
        }
        ...
        @Override
        @NonNull
        public DiscomfortIndexSensor1 createFromByteArray(@NonNull byte[] values) {
            BluetoothGattCharacteristic bluetoothGattCharacteristic = new BluetoothGattCharacteristic(DISCOMFORT_INDEX_SENSOR_1_CHARACTERISTIC, 0, 0);
            bluetoothGattCharacteristic.setValue(values);
            return new DiscomfortIndexSensor1(bluetoothGattCharacteristic);
        }
     ...
     *
     * @param bluetoothGattCharacteristic Characteristics UUID: 0x521F
     */
    public DiscomfortIndexSensor1(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     */
    public DiscomfortIndexSensor1(int eventEnableDisable, int simpleThresholdUpperLimit1, int simpleThresholdUpperLimit2, int simpleThresholdLowerLimit1, int simpleThresholdLowerLimit2, int changeThresholdRise1, int changeThresholdRise2, int changeThresholdDecline1, int changeThresholdDecline2) {
     ...
     * @param in Parcel
     */
    private DiscomfortIndexSensor1(@NonNull Parcel in) {
    ...
    /**
     * @return Simple threshold [upper limit] 1(Unit 0.01)
     */
    public double getSimpleThresholdUpperLimit1WithUnit() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Simple threshold [upper limit] 2(Unit 0.01)
     */
    public double getSimpleThresholdUpperLimit2WithUnit() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 1(Unit 0.01)
     */
    public double getSimpleThresholdLowerLimit1WithUnit() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 2(Unit 0.01)
     */
    public double getSimpleThresholdLowerLimit2WithUnit() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 1(Unit 0.01)
     */
    public double getChangeThresholdRise1WithUnit() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 2(Unit 0.01)
     */
    public double getChangeThresholdRise2WithUnit() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 1(Unit 0.01)
     */
    public double getChangeThresholdDecline1WithUnit() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 2(Unit 0.01)
     */
    public double getChangeThresholdDecline2WithUnit() {
        return mChangeThresholdDecline2 * EVENT_THRESHOLD_DISCOMFORT_INDEX_UNIT;
    }
