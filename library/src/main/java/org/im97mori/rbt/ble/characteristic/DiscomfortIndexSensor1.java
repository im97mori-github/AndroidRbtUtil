...
/**
 * 2.6.1 Event pattern Discomfort index (Characteristics UUID: 0x521F)
 */
@SuppressWarnings("WeakerAccess")
public class DiscomfortIndexSensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<DiscomfortIndexSensor1> CREATOR = new Creator<DiscomfortIndexSensor1>() {
