...
public abstract class AbstractRbtFilterBuilder<T> {
     ...
     * <p>
     * set original parser
     * if not set, {@link org.im97mori.rbt.ble.ad.RbtAdvertisingDataParser.Builder} with {@code true} will use
     * </p>
     *
     * @param parser {@link org.im97mori.rbt.ble.ad.RbtAdvertisingDataParser} instance for parse
     * @return myself
     */
