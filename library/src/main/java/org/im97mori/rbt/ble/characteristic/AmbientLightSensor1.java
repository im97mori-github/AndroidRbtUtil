...
/**
 * 2.6.1 Event pattern Ambient light 1 (Characteristics UUID: 0x5215)
 */
@SuppressWarnings("WeakerAccess")
public class AmbientLightSensor1 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<AmbientLightSensor1> CREATOR = new ByteArrayCreater<AmbientLightSensor1>() {
         ...
         */
        @Override
        public AmbientLightSensor1[] newArray(int size) {
            return new AmbientLightSensor1[size];
        }
     ...
     */
    public AmbientLightSensor1(int eventEnableDisable, int simpleThresholdUpperLimit1, int simpleThresholdUpperLimit2, int simpleThresholdLowerLimit1, int simpleThresholdLowerLimit2, int changeThresholdRise1, int changeThresholdRise2, int changeThresholdDecline1, int changeThresholdDecline2) {
    ...
    /**
     * @return Simple threshold [upper limit] 1(lx)
     */
    public double getSimpleThresholdUpperLimit1Lx() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Simple threshold [upper limit] 2(lx)
     */
    public double getSimpleThresholdUpperLimit2Lx() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 1(lx)
     */
    public double getSimpleThresholdLowerLimit1Lx() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 2(lx)
     */
    public double getSimpleThresholdLowerLimit2Lx() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 1(lx)
     */
    public double getChangeThresholdRise1Lx() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 2(lx)
     */
    public double getChangeThresholdRise2Lx() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 1(lx)
     */
    public double getChangeThresholdDecline1Lx() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 2(lx)
     */
    public double getChangeThresholdDecline2Lx() {
        return mChangeThresholdDecline2 * EVENT_THRESHOLD_AMBIENT_LIGHT_UNIT;
    }
