...
/**
 * 2.6.1 Event pattern Ambient light (Characteristics UUID: 0x5215)
 */
@SuppressWarnings("WeakerAccess")
public class AmbientLightSensor1 extends AbstractCharacteristic implements Parcelable {

    /**
     * @see Creator
     */
    public static final Creator<AmbientLightSensor1> CREATOR = new Creator<AmbientLightSensor1>() {
