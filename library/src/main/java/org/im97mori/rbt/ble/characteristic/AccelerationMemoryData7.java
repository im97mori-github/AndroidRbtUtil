...
public class AccelerationMemoryData7 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData7> CREATOR = new ByteArrayCreater<AccelerationMemoryData7>() {
         ...
         */
        @Override
        public AccelerationMemoryData7 createFromByteArray(byte[] values) {
