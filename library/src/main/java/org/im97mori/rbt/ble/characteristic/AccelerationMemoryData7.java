...
public class AccelerationMemoryData7 extends AbstractCharacteristic implements Parcelable {
     ...
     * @see Creator
     */
    public static final Creator<AccelerationMemoryData7> CREATOR = new Creator<AccelerationMemoryData7>() {

        /**
         * {@inheritDoc}
         */
        @Override
        public AccelerationMemoryData7 createFromParcel(Parcel in) {
     ...
     */
    public AccelerationMemoryData7(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData7(Parcel in) {
