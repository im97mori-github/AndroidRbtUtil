...
public class AccelerationMemoryData6 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData6> CREATOR = new ByteArrayCreater<AccelerationMemoryData6>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData6 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData6(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData6[] newArray(int size) {
            return new AccelerationMemoryData6[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData6 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData6(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData6(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData6(@NonNull Parcel in) {
