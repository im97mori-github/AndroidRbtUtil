...
public class AccelerationMemoryData6 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData6> CREATOR = new ByteArrayCreater<AccelerationMemoryData6>() {
         ...
         */
        @Override
        public AccelerationMemoryData6 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData6 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData6(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData6(Parcel in) {
