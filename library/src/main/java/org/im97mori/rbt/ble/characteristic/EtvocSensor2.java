...
/**
 * 2.6.2 Event pattern eTVOC 2 (Characteristics UUID: 0x521C)
 */
@SuppressWarnings("WeakerAccess")
public class EtvocSensor2 extends AbstractRbtCharacteristic implements Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<EtvocSensor2> CREATOR = new ByteArrayCreater<EtvocSensor2>() {
        ...
        @Override
        @NonNull
        public EtvocSensor2 createFromParcel(@NonNull Parcel in) {
            return new EtvocSensor2(in);
        }
        ...
        @Override
        @NonNull
        public EtvocSensor2[] newArray(int size) {
            return new EtvocSensor2[size];
        }
        ...
        @Override
        @NonNull
        public EtvocSensor2 createFromByteArray(@NonNull byte[] values) {
            BluetoothGattCharacteristic bluetoothGattCharacteristic = new BluetoothGattCharacteristic(ETVOC_SENSOR_2_CHARACTERISTIC, 0, 0);
            bluetoothGattCharacteristic.setValue(values);
            return new EtvocSensor2(bluetoothGattCharacteristic);
        }
     ...
     *
     * @param bluetoothGattCharacteristic Characteristics UUID: 0x521C
     */
    public EtvocSensor2(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private EtvocSensor2(@NonNull Parcel in) {
    ...
    /**
     * @return Average value threshold [upper](ppb)
     */
    public double getAverageValueThresholdUpperPpb() {
        return mAverageValueThresholdUpper * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Average value threshold [lower](ppb)
     */
    public double getAverageValueThresholdLowerPpb() {
        return mAverageValueThresholdLower * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Peak to Peak threshold [upper](ppb)
     */
    public double getPeakToPeakThresholdUpperPpb() {
        return mPeakToPeakThresholdUpper * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Peak to Peak threshold [lower](ppb)
     */
    public double getPeakToPeakThresholdLowerPpb() {
        return mPeakToPeakThresholdLower * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Interval difference threshold [upper](ppb)
     */
    public double getIntervalDifferenceThresholdUpperPpb() {
        return mIntervalDifferenceThresholdUpper * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Interval difference threshold [lower](ppb)
     */
    public double getIntervalDifferenceThresholdLowerPpb() {
        return mIntervalDifferenceThresholdLower * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Base difference threshold [upper](ppb)
     */
    public double getBaseDifferenceThresholdUpperPpb() {
        return mBaseDifferenceThresholdUpper * EVENT_THRESHOLD_ETVOC_UNIT;
    }
    ...
    /**
     * @return Base difference threshold [lower](ppb)
     */
    public double getBaseDifferenceThresholdLowerPpb() {
        return mBaseDifferenceThresholdLower * EVENT_THRESHOLD_ETVOC_UNIT;
    }
