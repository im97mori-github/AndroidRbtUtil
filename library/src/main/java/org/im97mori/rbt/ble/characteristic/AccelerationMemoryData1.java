...
public class AccelerationMemoryData1 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     * 0x0000: Fixed value
     */
    public static final int ACCELERATION_LOGGER_MODE_FIXED_VALUE = 0x0000;

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<AccelerationMemoryData1> CREATOR = new ByteArrayCreater<AccelerationMemoryData1>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData1 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData1(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData1[] newArray(int size) {
            return new AccelerationMemoryData1[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData1 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData1(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData1(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        mMaximumAccelerationXAxis = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_SINT16, 10);
        mMaximumAccelerationYAxis = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_SINT16, 12);
        mMaximumAccelerationZAxis = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_SINT16, 14);
        mTemperature = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_SINT16, 16);
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData1(@NonNull Parcel in) {
