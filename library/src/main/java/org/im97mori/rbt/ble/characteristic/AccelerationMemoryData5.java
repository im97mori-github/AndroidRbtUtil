...
public class AccelerationMemoryData5 extends AbstractRbtCharacteristic implements Parcelable {
    ...
    public static final ByteArrayCreater<AccelerationMemoryData5> CREATOR = new ByteArrayCreater<AccelerationMemoryData5>() {
         ...
         */
        @Override
        public AccelerationMemoryData5 createFromParcel(Parcel in) {
         ...
         */
        @Override
        public AccelerationMemoryData5 createFromByteArray(byte[] values) {
     ...
     */
    public AccelerationMemoryData5(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData5(Parcel in) {
