...
public class AccelerationMemoryData5 extends AbstractRbtCharacteristic implements Parcelable {
     ...
     */
    public static final ByteArrayCreater<AccelerationMemoryData5> CREATOR = new ByteArrayCreater<AccelerationMemoryData5>() {
        ...
        @Override
        @NonNull
        public AccelerationMemoryData5 createFromParcel(@NonNull Parcel in) {
            return new AccelerationMemoryData5(in);
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData5[] newArray(int size) {
            return new AccelerationMemoryData5[size];
        }
        ...
        @Override
        @NonNull
        public AccelerationMemoryData5 createFromByteArray(@NonNull byte[] values) {
            ...
            return new AccelerationMemoryData5(bluetoothGattCharacteristic);
        }
     ...
     */
    public AccelerationMemoryData5(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private AccelerationMemoryData5(@NonNull Parcel in) {
