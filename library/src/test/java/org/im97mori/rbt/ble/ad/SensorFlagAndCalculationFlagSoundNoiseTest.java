...
public class SensorFlagAndCalculationFlagSoundNoiseTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_soundNoise002() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise003() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise004() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise005() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise006() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise007() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise008() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise009() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise010() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise011() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise012() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise013() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise014() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise015() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise016() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
    ...
    public void test_soundNoise018() {
        ...
        data1[8] = (byte) 0x00; // Barometric pressure flag
        data1[9] = (byte) 0x00; // Barometric pressure flag
        data1[10] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER & 0xff); // Sound noise flag
        data1[11] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER >> 8) & 0xff); // Sound noise flag
        data1[12] = (byte) 0x00; // eTVOC flag
        data1[13] = (byte) 0x00; // eTVOC flag
        data1[14] = (byte) 0x00; // eCO2 flag
        data1[15] = (byte) 0x00; // eCO2 flag
