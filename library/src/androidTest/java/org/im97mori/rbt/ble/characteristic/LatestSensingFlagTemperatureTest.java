...
public class LatestSensingFlagTemperatureTest extends AbstractSensingFlagTest {

    @Test
    public void test_temperature001() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) ALL_EVENT_FLAG_SENSOR_LSB; // Temperature flag
        data1[2] = (byte) ALL_EVENT_FLAG_SENSOR_MSB; // Temperature flag
    ...
    public void test_temperature002() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature003() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature004() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature005() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature006() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature007() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature008() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature009() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature010() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature011() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature012() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature013() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature014() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature015() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature016() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature017() {
        byte[] data1 = new byte[15];
        data1[0] = (byte) 0x00; // Sequence number
        data1[1] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[2] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[3] = (byte) 0x00; // Relative humidity flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Ambient light flag
        data1[6] = (byte) 0x00; // Ambient light flag
