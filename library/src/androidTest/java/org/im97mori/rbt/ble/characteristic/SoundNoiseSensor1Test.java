...
public class SoundNoiseSensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        data[ 2] = (byte) ((0xe4) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x0c) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0xe4) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x0c) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0xe4) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x0c) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0xe4) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x0c) & 0xff); // Simple threshold [lower limit] 2
        ...
        SoundNoiseSensor1 result = new SoundNoiseSensor1(bluetoothGattCharacteristic);
        ...
        assertEquals(3300, result.getSimpleThresholdUpperLimit1());
        assertEquals(33.00d, result.getSimpleThresholdUpperLimit1Db(), 0);
        assertEquals(3300, result.getSimpleThresholdUpperLimit2());
        assertEquals(33.00d, result.getSimpleThresholdUpperLimit2Db(), 0);
        assertEquals(3300, result.getSimpleThresholdLowerLimit1());
        assertEquals(33.00d, result.getSimpleThresholdLowerLimit1Db(), 0);
        assertEquals(3300, result.getSimpleThresholdLowerLimit2());
        assertEquals(33.00d, result.getSimpleThresholdLowerLimit2Db(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Db(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Db(), 0);
        assertEquals(0, result.getChangeThresholdDecline1());
        assertEquals(0d, result.getChangeThresholdDecline1Db(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2Db(), 0);
    }
    ...
    public void test002() {
        ...
        data[ 2] = (byte) ((0xe0) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x2e) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0xe0) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x2e) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0xe0) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x2e) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0xe0) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x2e) & 0xff); // Simple threshold [lower limit] 2
        ...
        assertEquals(12000, result.getSimpleThresholdUpperLimit1());
        assertEquals(120.00d, result.getSimpleThresholdUpperLimit1Db(), 0);
        assertEquals(12000, result.getSimpleThresholdUpperLimit2());
        assertEquals(120.00d, result.getSimpleThresholdUpperLimit2Db(), 0);
        assertEquals(12000, result.getSimpleThresholdLowerLimit1());
        assertEquals(120.00d, result.getSimpleThresholdLowerLimit1Db(), 0);
        assertEquals(12000, result.getSimpleThresholdLowerLimit2());
        assertEquals(120.00d, result.getSimpleThresholdLowerLimit2Db(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(100.00d, result.getChangeThresholdRise1Db(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(100.00d, result.getChangeThresholdRise2Db(), 0);
        assertEquals(10000, result.getChangeThresholdDecline1());
        assertEquals(100.00d, result.getChangeThresholdDecline1Db(), 0);
        assertEquals(10000, result.getChangeThresholdDecline2());
        assertEquals(100.00d, result.getChangeThresholdDecline2Db(), 0);
    }
    ...
    public void test101() {
        ...
        SoundNoiseSensor1 result1 = new SoundNoiseSensor1(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        SoundNoiseSensor1 result2 = SoundNoiseSensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        SoundNoiseSensor1 result1 = new SoundNoiseSensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        SoundNoiseSensor1 result1 = new SoundNoiseSensor1(bluetoothGattCharacteristic);
        SoundNoiseSensor1 result2 = SoundNoiseSensor1.CREATOR.createFromByteArray(data);
