...
public class SensorFlagAndCalculationFlagTemperatureTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_temperature002() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature003() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature004() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature005() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature006() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature007() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature008() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature009() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature010() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature011() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature012() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature013() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature014() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature015() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature016() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
    ...
    public void test_temperature017() {
        ...
        data1[0] = DATA_TYPE_SENSOR_FLAG_AND_CALCULATION_FLAG;
        data1[1] = (byte) 0x00; // Sequence number
        data1[2] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER & 0xff); // Temperature flag
        data1[3] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER >> 8) & 0xff); // Temperature flag
        data1[4] = (byte) 0x00; // Relative humidity flag
        data1[5] = (byte) 0x00; // Relative humidity flag
        data1[6] = (byte) 0x00; // Ambient light flag
        data1[7] = (byte) 0x00; // Ambient light flag
