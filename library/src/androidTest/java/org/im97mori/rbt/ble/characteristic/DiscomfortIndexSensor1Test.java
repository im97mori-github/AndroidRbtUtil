...
public class DiscomfortIndexSensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        DiscomfortIndexSensor1 result = new DiscomfortIndexSensor1(bluetoothGattCharacteristic);
        ...
        assertEquals(0d, result.getSimpleThresholdLowerLimit1WithUnit(), 0);
        assertEquals(0, result.getSimpleThresholdLowerLimit2());
        assertEquals(0d, result.getSimpleThresholdLowerLimit2WithUnit(), 0);
        ...
        assertEquals(0d, result.getChangeThresholdDecline1WithUnit(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2WithUnit(), 0);
    }
    ...
    public void test002() {
        ...
        assertEquals(100.00d, result.getSimpleThresholdUpperLimit1WithUnit(), 0);
        assertEquals(10000, result.getSimpleThresholdUpperLimit2());
        assertEquals(100.00d, result.getSimpleThresholdUpperLimit2WithUnit(), 0);
        assertEquals(10000, result.getSimpleThresholdLowerLimit1());
        assertEquals(100.00d, result.getSimpleThresholdLowerLimit1WithUnit(), 0);
        assertEquals(10000, result.getSimpleThresholdLowerLimit2());
        assertEquals(100.00d, result.getSimpleThresholdLowerLimit2WithUnit(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(100.00d, result.getChangeThresholdRise1WithUnit(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(100.00d, result.getChangeThresholdRise2WithUnit(), 0);
        assertEquals(10000, result.getChangeThresholdDecline1());
        assertEquals(100.00d, result.getChangeThresholdDecline1WithUnit(), 0);
        assertEquals(10000, result.getChangeThresholdDecline2());
        assertEquals(100.00d, result.getChangeThresholdDecline2WithUnit(), 0);
    }
    ...
    public void test101() {
        ...
        DiscomfortIndexSensor1 result1 = new DiscomfortIndexSensor1(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        DiscomfortIndexSensor1 result2 = DiscomfortIndexSensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        DiscomfortIndexSensor1 result1 = new DiscomfortIndexSensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        DiscomfortIndexSensor1 result1 = new DiscomfortIndexSensor1(bluetoothGattCharacteristic);
        DiscomfortIndexSensor1 result2 = DiscomfortIndexSensor1.CREATOR.createFromByteArray(data);
