...
public class Eco2Sensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        data[ 2] = (byte) ((0x90) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x01) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0x90) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x01) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0x90) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x01) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0x90) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x01) & 0xff); // Simple threshold [lower limit] 2
        ...
        Eco2Sensor1 result = new Eco2Sensor1(bluetoothGattCharacteristic);
        ...
        assertEquals(400, result.getSimpleThresholdUpperLimit1());
        assertEquals(400d, result.getSimpleThresholdUpperLimit1Ppm(), 0);
        assertEquals(400, result.getSimpleThresholdUpperLimit2());
        assertEquals(400d, result.getSimpleThresholdUpperLimit2Ppm(), 0);
        assertEquals(400, result.getSimpleThresholdLowerLimit1());
        assertEquals(400d, result.getSimpleThresholdLowerLimit1Ppm(), 0);
        assertEquals(400, result.getSimpleThresholdLowerLimit2());
        assertEquals(400d, result.getSimpleThresholdLowerLimit2Ppm(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Ppm(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Ppm(), 0);
        assertEquals(0, result.getChangeThresholdDecline1());
        assertEquals(0d, result.getChangeThresholdDecline1Ppm(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2Ppm(), 0);
    }
    ...
    public void test002() {
        ...
        data[ 3] = (byte) ((0x7f) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0xff) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x7f) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0xff) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x7f) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0xff) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x7f) & 0xff); // Simple threshold [lower limit] 2
        ...
        assertEquals(32767, result.getSimpleThresholdUpperLimit1());
        assertEquals(32767d, result.getSimpleThresholdUpperLimit1Ppm(), 0);
        assertEquals(32767, result.getSimpleThresholdUpperLimit2());
        assertEquals(32767d, result.getSimpleThresholdUpperLimit2Ppm(), 0);
        assertEquals(32767, result.getSimpleThresholdLowerLimit1());
        assertEquals(32767d, result.getSimpleThresholdLowerLimit1Ppm(), 0);
        assertEquals(32767, result.getSimpleThresholdLowerLimit2());
        assertEquals(32767d, result.getSimpleThresholdLowerLimit2Ppm(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(10000d, result.getChangeThresholdRise1Ppm(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(10000d, result.getChangeThresholdRise2Ppm(), 0);
        assertEquals(10000, result.getChangeThresholdDecline1());
        assertEquals(10000d, result.getChangeThresholdDecline1Ppm(), 0);
        assertEquals(10000, result.getChangeThresholdDecline2());
        assertEquals(10000d, result.getChangeThresholdDecline2Ppm(), 0);
    }
    ...
    public void test101() {
        ...
        Eco2Sensor1 result1 = new Eco2Sensor1(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        Eco2Sensor1 result2 = Eco2Sensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        Eco2Sensor1 result1 = new Eco2Sensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        Eco2Sensor1 result1 = new Eco2Sensor1(bluetoothGattCharacteristic);
        Eco2Sensor1 result2 = Eco2Sensor1.CREATOR.createFromByteArray(data);
