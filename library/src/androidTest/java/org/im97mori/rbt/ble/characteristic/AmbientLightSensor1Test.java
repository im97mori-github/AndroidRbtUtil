...
public class AmbientLightSensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        AmbientLightSensor1 result = new AmbientLightSensor1(bluetoothGattCharacteristic);
        ...
        assertEquals(0d, result.getSimpleThresholdUpperLimit1Lx(), 0);
        assertEquals(0, result.getSimpleThresholdUpperLimit2());
        assertEquals(0d, result.getSimpleThresholdUpperLimit2Lx(), 0);
        assertEquals(0, result.getSimpleThresholdLowerLimit1());
        assertEquals(0d, result.getSimpleThresholdLowerLimit1Lx(), 0);
        assertEquals(0, result.getSimpleThresholdLowerLimit2());
        assertEquals(0d, result.getSimpleThresholdLowerLimit2Lx(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Lx(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Lx(), 0);
        assertEquals(0, result.getChangeThresholdDecline1());
        assertEquals(0d, result.getChangeThresholdDecline1Lx(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2Lx(), 0);
    }
    ...
    public void test002() {
        ...
        data[ 2] = (byte) ((0x30) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x75) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0x30) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x75) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0x30) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x75) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0x30) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x75) & 0xff); // Simple threshold [lower limit] 2
        data[10] = (byte) ((0x30) & 0xff); // Change threshold [rise] 1
        data[11] = (byte) ((0x75) & 0xff); // Change threshold [rise] 1
        data[12] = (byte) ((0x30) & 0xff); // Change threshold [rise] 2
        data[13] = (byte) ((0x75) & 0xff); // Change threshold [rise] 2
        data[14] = (byte) ((0x30) & 0xff); // Change threshold [decline] 1
        data[15] = (byte) ((0x75) & 0xff); // Change threshold [decline] 1
        data[16] = (byte) ((0x30) & 0xff); // Change threshold [decline] 2
        data[17] = (byte) ((0x75) & 0xff); // Change threshold [decline] 2
        data[18] = (byte) ((0xff) & 0xff); // Reserve for Future Use
        data[19] = (byte) ((0xff) & 0xff); // Reserve for Future Use
        //@formatter:on
        ...
        assertEquals(30000, result.getSimpleThresholdUpperLimit1());
        assertEquals(30000d, result.getSimpleThresholdUpperLimit1Lx(), 0);
        assertEquals(30000, result.getSimpleThresholdUpperLimit2());
        assertEquals(30000d, result.getSimpleThresholdUpperLimit2Lx(), 0);
        assertEquals(30000, result.getSimpleThresholdLowerLimit1());
        assertEquals(30000d, result.getSimpleThresholdLowerLimit1Lx(), 0);
        assertEquals(30000, result.getSimpleThresholdLowerLimit2());
        assertEquals(30000d, result.getSimpleThresholdLowerLimit2Lx(), 0);
        assertEquals(30000, result.getChangeThresholdRise1());
        assertEquals(30000d, result.getChangeThresholdRise1Lx(), 0);
        assertEquals(30000, result.getChangeThresholdRise2());
        assertEquals(30000d, result.getChangeThresholdRise2Lx(), 0);
        assertEquals(30000, result.getChangeThresholdDecline1());
        assertEquals(30000d, result.getChangeThresholdDecline1Lx(), 0);
        assertEquals(30000, result.getChangeThresholdDecline2());
        assertEquals(30000d, result.getChangeThresholdDecline2Lx(), 0);
    }
    ...
    public void test101() {
        ...
        AmbientLightSensor1 result1 = new AmbientLightSensor1(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        AmbientLightSensor1 result2 = AmbientLightSensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        AmbientLightSensor1 result1 = new AmbientLightSensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        AmbientLightSensor1 result1 = new AmbientLightSensor1(bluetoothGattCharacteristic);
        AmbientLightSensor1 result2 = AmbientLightSensor1.CREATOR.createFromByteArray(data);
