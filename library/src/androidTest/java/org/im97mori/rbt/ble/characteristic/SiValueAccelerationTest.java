...
public class SiValueAccelerationTest extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        SiValueAcceleration result = new SiValueAcceleration(bluetoothGattCharacteristic);
        ...
        assertEquals(0d, result.getSimpleThresholdUpperLimit1Kine(), 0);
        assertEquals(0, result.getSimpleThresholdUpperLimit2());
        assertEquals(0d, result.getSimpleThresholdUpperLimit2Kine(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Kine(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Kine(), 0);
    }
    ...
    public void test002() {
        ...
        assertEquals(6553.5d, result.getSimpleThresholdUpperLimit1Kine(), 0);
        assertEquals(65535, result.getSimpleThresholdUpperLimit2());
        assertEquals(6553.5d, result.getSimpleThresholdUpperLimit2Kine(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(1000.0d, result.getChangeThresholdRise1Kine(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(1000.0d, result.getChangeThresholdRise2Kine(), 0);
    }
    ...
    public void test101() {
        ...
        SiValueAcceleration result1 = new SiValueAcceleration(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        SiValueAcceleration result2 = SiValueAcceleration.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        SiValueAcceleration result1 = new SiValueAcceleration(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, changeThresholdRise1, changeThresholdRise2);
    ...
    public void test104() {
        ...
        SiValueAcceleration result1 = new SiValueAcceleration(bluetoothGattCharacteristic);
        SiValueAcceleration result2 = SiValueAcceleration.CREATOR.createFromByteArray(data);
