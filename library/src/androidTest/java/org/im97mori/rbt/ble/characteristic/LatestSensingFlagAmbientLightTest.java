...
public class LatestSensingFlagAmbientLightTest extends AbstractSensingFlagTest {
    ...
    public void test_ambientLight001() {
        ...
        data1[ 5] = (byte) ALL_EVENT_FLAG_SENSOR_LSB; // Ambient light flag
        data1[ 6] = (byte) ALL_EVENT_FLAG_SENSOR_MSB; // Ambient light flag
    ...
    public void test_ambientLight002() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_1 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight003() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_UPPER_LIMIT_2 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight004() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_1 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight005() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.SIMPLE_THRESHOLD_LOWER_LIMIT_2 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight006() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_1 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight007() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_RISE_2 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight008() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_1 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight009() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.CHANGE_THRESHOLD_DECLINE_2 >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight010() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_UPPER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight011() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.AVERAGE_VALUE_THRESHOLD_LOWER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight012() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_UPPER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight013() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.PEAK_TO_PEAK_THRESHOLD_LOWER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight014() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_RISE >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight015() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.INTERVAL_DIFFERENCE_THRESHOLD_DECLINE >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight016() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_UPPER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
    ...
    public void test_ambientLight017() {
        ...
        data1[ 3] = (byte) 0x00; // Relative humidity flag
        data1[ 4] = (byte) 0x00; // Relative humidity flag
        data1[ 5] = (byte) (RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER & 0xff); // Ambient light flag
        data1[ 6] = (byte) ((RbtConstants.EventFlagSensor.BASE_DIFFERENCE_THRESHOLD_LOWER >> 8) & 0xff); // Ambient light flag
        data1[ 7] = (byte) 0x00; // Barometric pressure flag
        data1[ 8] = (byte) 0x00; // Barometric pressure flag
        data1[ 9] = (byte) 0x00; // Sound noise flag
        data1[10] = (byte) 0x00; // Sound noise flag
