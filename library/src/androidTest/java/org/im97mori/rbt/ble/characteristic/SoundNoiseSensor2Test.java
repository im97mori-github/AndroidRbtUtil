...
public class SoundNoiseSensor2Test extends AbstractEventEnableDisableTest {

    @Test
    public void test001() {
        byte[] data = new byte[20];
        data[ 0] = (byte) ((0xe4) & 0xff); // Average value threshold [upper]
        data[ 1] = (byte) ((0x0c) & 0xff); // Average value threshold [upper]
        data[ 2] = (byte) ((0xe4) & 0xff); // Average value threshold [lower]
        data[ 3] = (byte) ((0x0c) & 0xff); // Average value threshold [lower]
        ...
        SoundNoiseSensor2 result = new SoundNoiseSensor2(bluetoothGattCharacteristic);
        assertEquals(3300, result.getAverageValueThresholdUpper());
        assertEquals(33.00d, result.getAverageValueThresholdUpperDb(), 0);
        assertEquals(3300, result.getAverageValueThresholdLower());
        assertEquals(33.00d, result.getAverageValueThresholdLowerDb(), 0);
        assertEquals(0, result.getPeakToPeakThresholdUpper());
        assertEquals(0d, result.getPeakToPeakThresholdUpperDb(), 0);
        assertEquals(0, result.getPeakToPeakThresholdLower());
        assertEquals(0d, result.getPeakToPeakThresholdLowerDb(), 0);
        assertEquals(0, result.getIntervalDifferenceThresholdUpper());
        assertEquals(0d, result.getIntervalDifferenceThresholdUpperDb(), 0);
        assertEquals(0, result.getIntervalDifferenceThresholdLower());
        assertEquals(0d, result.getIntervalDifferenceThresholdLowerDb(), 0);
        assertEquals(0, result.getBaseDifferenceThresholdUpper());
        assertEquals(0d, result.getBaseDifferenceThresholdUpperDb(), 0);
        assertEquals(0, result.getBaseDifferenceThresholdLower());
        assertEquals(0d, result.getBaseDifferenceThresholdLowerDb(), 0);
    ...
    public void test002() {
        byte[] data = new byte[20];
        data[ 0] = (byte) ((0xe0) & 0xff); // Average value threshold [upper]
        data[ 1] = (byte) ((0x2e) & 0xff); // Average value threshold [upper]
        data[ 2] = (byte) ((0xe0) & 0xff); // Average value threshold [lower]
        data[ 3] = (byte) ((0x2e) & 0xff); // Average value threshold [lower]
        ...
        SoundNoiseSensor2 result = new SoundNoiseSensor2(bluetoothGattCharacteristic);
        assertEquals(12000, result.getAverageValueThresholdUpper());
        assertEquals(120.00d, result.getAverageValueThresholdUpperDb(), 0);
        assertEquals(12000, result.getAverageValueThresholdLower());
        assertEquals(120.00d, result.getAverageValueThresholdLowerDb(), 0);
        assertEquals(10000, result.getPeakToPeakThresholdUpper());
        assertEquals(100.00d, result.getPeakToPeakThresholdUpperDb(), 0);
        assertEquals(10000, result.getPeakToPeakThresholdLower());
        assertEquals(100.00d, result.getPeakToPeakThresholdLowerDb(), 0);
        assertEquals(10000, result.getIntervalDifferenceThresholdUpper());
        assertEquals(100.00d, result.getIntervalDifferenceThresholdUpperDb(), 0);
        assertEquals(10000, result.getIntervalDifferenceThresholdLower());
        assertEquals(100.00d, result.getIntervalDifferenceThresholdLowerDb(), 0);
        assertEquals(10000, result.getBaseDifferenceThresholdUpper());
        assertEquals(100.00d, result.getBaseDifferenceThresholdUpperDb(), 0);
        assertEquals(10000, result.getBaseDifferenceThresholdLower());
        assertEquals(100.00d, result.getBaseDifferenceThresholdLowerDb(), 0);
    ...
    public void test101() {
        ...
        SoundNoiseSensor2 result1 = new SoundNoiseSensor2(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        SoundNoiseSensor2 result2 = SoundNoiseSensor2.CREATOR.createFromParcel(parcel);
    ...
    public void test104() {
        ...
        SoundNoiseSensor2 result1 = new SoundNoiseSensor2(bluetoothGattCharacteristic);
        SoundNoiseSensor2 result2 = SoundNoiseSensor2.CREATOR.createFromByteArray(data);
