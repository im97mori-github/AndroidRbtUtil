...
public class AccelerationMemoryDataData9Test {
    ...
    public void test001() {
        ...
        AccelerationMemoryData9 result = new AccelerationMemoryData9(bluetoothGattCharacteristic);
    ...
    public void test003() {
        byte[] data = new byte[20];
        data[0] = (byte) ((AccelerationMemoryData9.DATA_ERROR_BIT) & 0xff);
        data[1] = (byte) ((AccelerationMemoryData9.DATA_ERROR_BIT >> 8) & 0xff);
        data[ 2] = (byte) ((0x20) & 0xff);
        data[ 3] = (byte) ((0x4e) & 0xff);
        data[ 4] = (byte) ((0x20) & 0xff);
        data[ 5] = (byte) ((0x4e) & 0xff);
    ...
    public void test004() {
        ...
        AccelerationMemoryData9 result1 = new AccelerationMemoryData9(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        AccelerationMemoryData9 result2 = AccelerationMemoryData9.CREATOR.createFromParcel(parcel);
    ...
    public void test006() {
        ...
        AccelerationMemoryData9 result1 = new AccelerationMemoryData9(bluetoothGattCharacteristic);
        AccelerationMemoryData9 result2 = AccelerationMemoryData9.CREATOR.createFromByteArray(data);
