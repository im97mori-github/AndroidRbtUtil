...
public class SensorFlagAndCalculationFlagSiValueTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_siValue002() {
        ...
        data2[4] = (byte) 0x00; // Heat stroke flag
        data2[5] = (byte) 0x00; // Heat stroke flag
        data2[6] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // SI value flag
        data2[7] = (byte) 0x00; // PGA flag
        data2[8] = (byte) 0x00; // Seismic intensity flag
        data2[9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_siValue003() {
        ...
        data2[4] = (byte) 0x00; // Heat stroke flag
        data2[5] = (byte) 0x00; // Heat stroke flag
        data2[6] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // SI value flag
        data2[7] = (byte) 0x00; // PGA flag
        data2[8] = (byte) 0x00; // Seismic intensity flag
        data2[9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_siValue004() {
        ...
        data2[4] = (byte) 0x00; // Heat stroke flag
        data2[5] = (byte) 0x00; // Heat stroke flag
        data2[6] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_1 & 0xff); // SI value flag
        data2[7] = (byte) 0x00; // PGA flag
        data2[8] = (byte) 0x00; // Seismic intensity flag
        data2[9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_siValue005() {
        ...
        data2[4] = (byte) 0x00; // Heat stroke flag
        data2[5] = (byte) 0x00; // Heat stroke flag
        data2[6] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_2 & 0xff); // SI value flag
        data2[7] = (byte) 0x00; // PGA flag
        data2[8] = (byte) 0x00; // Seismic intensity flag
        data2[9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
