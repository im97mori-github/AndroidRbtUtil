...
public class RelativeHumiditySensor2Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        assertEquals(0d, result.getAverageValueThresholdUpperRh(), 0);
        assertEquals(0, result.getAverageValueThresholdLower());
        assertEquals(0d, result.getAverageValueThresholdLowerRh(), 0);
        assertEquals(0, result.getPeakToPeakThresholdUpper());
        assertEquals(0d, result.getPeakToPeakThresholdUpperRh(), 0);
        assertEquals(0, result.getPeakToPeakThresholdLower());
        assertEquals(0d, result.getPeakToPeakThresholdLowerRh(), 0);
        assertEquals(0, result.getIntervalDifferenceThresholdUpper());
        assertEquals(0d, result.getIntervalDifferenceThresholdUpperRh(), 0);
        assertEquals(0, result.getIntervalDifferenceThresholdLower());
        assertEquals(0d, result.getIntervalDifferenceThresholdLowerRh(), 0);
        assertEquals(0, result.getBaseDifferenceThresholdUpper());
        assertEquals(0d, result.getBaseDifferenceThresholdUpperRh(), 0);
        assertEquals(0, result.getBaseDifferenceThresholdLower());
        assertEquals(0d, result.getBaseDifferenceThresholdLowerRh(), 0);
    ...
    public void test002() {
        ...
        assertEquals(100.00d, result.getAverageValueThresholdUpperRh(), 0);
        assertEquals(10000, result.getAverageValueThresholdLower());
        assertEquals(100.00d, result.getAverageValueThresholdLowerRh(), 0);
        assertEquals(10000, result.getPeakToPeakThresholdUpper());
        assertEquals(100.00d, result.getPeakToPeakThresholdUpperRh(), 0);
        assertEquals(10000, result.getPeakToPeakThresholdLower());
        assertEquals(100.00d, result.getPeakToPeakThresholdLowerRh(), 0);
        assertEquals(10000, result.getIntervalDifferenceThresholdUpper());
        assertEquals(100.00d, result.getIntervalDifferenceThresholdUpperRh(), 0);
        assertEquals(10000, result.getIntervalDifferenceThresholdLower());
        assertEquals(100.00d, result.getIntervalDifferenceThresholdLowerRh(), 0);
        assertEquals(10000, result.getBaseDifferenceThresholdUpper());
        assertEquals(100.00d, result.getBaseDifferenceThresholdUpperRh(), 0);
        assertEquals(10000, result.getBaseDifferenceThresholdLower());
        assertEquals(100.00d, result.getBaseDifferenceThresholdLowerRh(), 0);
    ...
    public void test101() {
        ...
        RelativeHumiditySensor2 result2 = RelativeHumiditySensor2.CREATOR.createFromParcel(parcel);
    ...
    public void test104() {
        ...
        RelativeHumiditySensor2 result1 = new RelativeHumiditySensor2(bluetoothGattCharacteristic);
        RelativeHumiditySensor2 result2 = RelativeHumiditySensor2.CREATOR.createFromByteArray(data);
