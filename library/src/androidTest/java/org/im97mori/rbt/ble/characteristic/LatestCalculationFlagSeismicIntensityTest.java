...
public class LatestCalculationFlagSeismicIntensityTest extends AbstractSensingFlagTest {
    ...
    public void test_seismicIntensity002() {
        ...
        data2[5] = (byte) 0x00; // SI value flag
        data2[6] = (byte) 0x00; // PGA flag
        data2[7] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Seismic intensity flag
    ...
    public void test_seismicIntensity003() {
        ...
        data2[5] = (byte) 0x00; // SI value flag
        data2[6] = (byte) 0x00; // PGA flag
        data2[7] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // Seismic intensity flag
    ...
    public void test_seismicIntensity004() {
        ...
        data2[5] = (byte) 0x00; // SI value flag
        data2[6] = (byte) 0x00; // PGA flag
        data2[7] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_1 & 0xff); // Seismic intensity flag
    ...
    public void test_seismicIntensity005() {
        ...
        data2[5] = (byte) 0x00; // SI value flag
        data2[6] = (byte) 0x00; // PGA flag
        data2[7] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_2 & 0xff); // Seismic intensity flag
