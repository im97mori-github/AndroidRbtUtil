...
public class SensorFlagAndCalculationFlagPgaTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_pga002() {
        ...
        data2[ 5] = (byte) 0x00; // Heat stroke flag
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // PGA flag
        data2[ 8] = (byte) 0x00; // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_pga003() {
        ...
        data2[ 5] = (byte) 0x00; // Heat stroke flag
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); // PGA flag
        data2[ 8] = (byte) 0x00; // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_pga004() {
        ...
        data2[ 5] = (byte) 0x00; // Heat stroke flag
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_1 & 0xff); // PGA flag
        data2[ 8] = (byte) 0x00; // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_pga005() {
        ...
        data2[ 5] = (byte) 0x00; // Heat stroke flag
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_2 & 0xff); // PGA flag
        data2[ 8] = (byte) 0x00; // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
