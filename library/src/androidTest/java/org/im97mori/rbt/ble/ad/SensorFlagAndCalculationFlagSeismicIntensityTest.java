...
public class SensorFlagAndCalculationFlagSeismicIntensityTest extends AbstractSensorFlagAndCalculationFlagTest {
    ...
    public void test_seismicIntensity001() {
        ...
        data2[ 8] = (byte) ALL_EVENT_FLAG_ACCELERATION; // SI valueflag
    ...
    public void test_seismicIntensity002() {
        ...
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) 0x00; // PGA flag
        data2[ 8] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_1 & 0xff); // Seismic intensity flag
        data2[ 9] = (byte) 0xff; //  Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
        data2[12] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_seismicIntensity003() {
        ...
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) 0x00; // PGA flag
        data2[ 8] = (byte) (RbtConstants.EventFlagAcceleration.SIMPLE_THRESHOLD_UPPER_LIMIT_2 & 0xff); //  Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
        data2[12] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_seismicIntensity004() {
        ...
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) 0x00; // PGA flag
        data2[ 8] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_1 & 0xff); // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
        data2[12] = (byte) 0xff; // Reserve for Future Use
    ...
    public void test_seismicIntensity005() {
        ...
        data2[ 6] = (byte) 0x00; // SI value flag
        data2[ 7] = (byte) 0x00; // PGA flag
        data2[ 8] = (byte) (RbtConstants.EventFlagAcceleration.CHANGE_THRESHOLD_RISE_2 & 0xff); // Seismic intensity flag
        data2[ 9] = (byte) 0xff; // Reserve for Future Use
        data2[10] = (byte) 0xff; // Reserve for Future Use
        data2[11] = (byte) 0xff; // Reserve for Future Use
        data2[12] = (byte) 0xff; // Reserve for Future Use
