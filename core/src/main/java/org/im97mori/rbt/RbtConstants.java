...
public class RbtConstants {
    ...
    public static final class EventEnableDisableSensor {
        ...
        /**
         * all event sensor flag
         */
        public static final int ALL_EVENT_FLAG_SENSOR =
                SIMPLE_THRESHOLD_UPPER_LIMIT_1
                        | SIMPLE_THRESHOLD_UPPER_LIMIT_2
                        | SIMPLE_THRESHOLD_LOWER_LIMIT_1
                        | SIMPLE_THRESHOLD_LOWER_LIMIT_2
                        | CHANGE_THRESHOLD_RISE_1
                        | CHANGE_THRESHOLD_RISE_2
                        | CHANGE_THRESHOLD_DECLINE_1
                        | CHANGE_THRESHOLD_DECLINE_2
                        | AVERAGE_VALUE_THRESHOLD_UPPER
                        | AVERAGE_VALUE_THRESHOLD_LOWER
                        | PEAK_TO_PEAK_THRESHOLD_UPPER
                        | PEAK_TO_PEAK_THRESHOLD_LOWER
                        | INTERVAL_DIFFERENCE_THRESHOLD_RISE
                        | INTERVAL_DIFFERENCE_THRESHOLD_DECLINE
                        | BASE_DIFFERENCE_THRESHOLD_UPPER
                        | BASE_DIFFERENCE_THRESHOLD_LOWER;

        /**
         * all event sensor flag(msb)
         */
        public static final int ALL_EVENT_FLAG_SENSOR_MSB = (ALL_EVENT_FLAG_SENSOR >> 8) & 0xff;

        /**
         * all event sensor flag(lsb)
         */
        public static final int ALL_EVENT_FLAG_SENSOR_LSB = ALL_EVENT_FLAG_SENSOR & 0xff;
    }
    ...
    public static final class EventEnableDisableAcceleration {
        ...
        /**
         * all event acceleration flag
         */
        public static final int ALL_EVENT_FLAG_ACCELERATION =
                SIMPLE_THRESHOLD_UPPER_LIMIT_1
                        | SIMPLE_THRESHOLD_UPPER_LIMIT_2
                        | CHANGE_THRESHOLD_RISE_1
                        | CHANGE_THRESHOLD_RISE_2;
