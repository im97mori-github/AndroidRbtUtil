...
public class LatestDataServiceSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback {
    ...
    private static class TestScanCallback extends ScanCallback {
        ...
        private TestScanCallback(LatestDataServiceSampleActivity activity) {
            mActivity = activity;
                    ...
                    mActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                mActivity.mBluetoothLeScanner.stopScan(LatestDataServiceSampleActivity.TestScanCallback.this);
