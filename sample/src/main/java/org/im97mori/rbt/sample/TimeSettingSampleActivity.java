...
public class TimeSettingSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback{
    ...
    private static class TestScanCallback extends FilteredRbtScanCallback {
        ...
        private static class Builder extends FilteredRbtScanCallback.Builder {
            ...
            private final TimeSettingSampleActivity mActivity;

            Builder(@NonNull TimeSettingSampleActivity activity) {
                mActivity = activity;
            }
        ...
        private TestScanCallback(@NonNull List<AdvertisingDataFilter<RbtAdvertisingDataParser.RbtAdvertisingDataParseResult>> filterList, @Nullable RbtAdvertisingDataParser parser, @Nullable ScanCallback scanCallback, @NonNull TimeSettingSampleActivity activity) {
