...
public class AccelerationServiceSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback {
    ...
    private static class TestScanCallback extends ScanCallback {
        ...
        private TestScanCallback(AccelerationServiceSampleActivity activity) {
            mActivity = activity;
                    ...
                    mActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                mActivity.mBluetoothLeScanner.stopScan(AccelerationServiceSampleActivity.TestScanCallback.this);
