...
public class InformationServiceSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback {
    ...
    private static class TestScanCallback extends FilteredRbtScanCallback {
        ...
        private static class Builder extends FilteredRbtScanCallback.Builder {
            ...
            private final InformationServiceSampleActivity mActivity;

            Builder(@NonNull InformationServiceSampleActivity activity) {
                mActivity = activity;
            }
        ...
        private TestScanCallback(@NonNull List<AdvertisingDataFilter<RbtAdvertisingDataParser.RbtAdvertisingDataParseResult>> filterList, @Nullable RbtAdvertisingDataParser parser, @Nullable ScanCallback scanCallback, @NonNull InformationServiceSampleActivity activity) {
