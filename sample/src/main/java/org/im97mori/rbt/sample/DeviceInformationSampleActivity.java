...
public class DeviceInformationSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback {
    ...
    private static class TestScanCallback extends FilteredRbtScanCallback {
        ...
        private static class Builder extends FilteredRbtScanCallback.Builder {
            ...
            private final DeviceInformationSampleActivity mActivity;

            Builder(@NonNull DeviceInformationSampleActivity activity) {
                mActivity = activity;
            }
        ...
        final DeviceInformationSampleActivity mActivity;

        private TestScanCallback(@NonNull List<AdvertisingDataFilter<RbtAdvertisingDataParser.RbtAdvertisingDataParseResult>> filterList, @Nullable RbtAdvertisingDataParser parser, @Nullable ScanCallback scanCallback, @NonNull DeviceInformationSampleActivity activity) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (R.id.read_model_number_string == item.getItemId()) {
            mRbtBLEConnection.readModelNumberString();
        } else if (R.id.read_serial_number_string == item.getItemId()) {
            mRbtBLEConnection.readSerialNumberString();
        } else if (R.id.read_firmware_revision_string == item.getItemId()) {
            mRbtBLEConnection.readFirmwareRevisionString();
        } else if (R.id.read_hardware_revision_string == item.getItemId()) {
            mRbtBLEConnection.readHardwareRevisionString();
        } else if (R.id.read_manufacturer_name_string == item.getItemId()) {
            mRbtBLEConnection.readManufacturerNameString();
        }
        return true;
    }
