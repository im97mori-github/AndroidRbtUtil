...
public class DeviceInformationSampleActivity extends BaseActivity implements View.OnClickListener, SampleCallback {
    ...
    private static class TestScanCallback extends ScanCallback {
        ...
        private TestScanCallback(DeviceInformationSampleActivity activity) {
            mActivity = activity;
                    ...
                    mActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                mActivity.mBluetoothLeScanner.stopScan(DeviceInformationSampleActivity.TestScanCallback.this);
