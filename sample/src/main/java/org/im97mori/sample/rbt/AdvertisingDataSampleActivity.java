package org.im97mori.sample.rbt;
    ...
    private static class TestScanCallback extends ScanCallback {
        ...
        private void parse(ScanResult result) {
            ...
            if (record != null) {
                ...
                if (rbtAdvertisingDataParseResult != null
                        && (rbtAdvertisingDataParseResult.getSensorData() != null
                        || rbtAdvertisingDataParseResult.getCalculationData() != null
                        || rbtAdvertisingDataParseResult.getSensorDataAndCalculationData() != null
                        || rbtAdvertisingDataParseResult.getSensorFlagAndCalculationFlag() != null
                        || rbtAdvertisingDataParseResult.getSerialNumber() != null)) {
