...
public class EtvocSensor1 implements ByteArrayInterface, Parcelable {
    ...
    public static final ByteArrayCreater<EtvocSensor1> CREATOR = new ByteArrayCreater<EtvocSensor1>() {
        ...
        @Override
        @NonNull
        public EtvocSensor1 createFromParcel(@NonNull Parcel in) {
        ...
        @Override
        @NonNull
        public EtvocSensor1 createFromByteArray(@NonNull byte[] values) {
     ...
     */
    public EtvocSensor1(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private EtvocSensor1(@NonNull Parcel in) {
