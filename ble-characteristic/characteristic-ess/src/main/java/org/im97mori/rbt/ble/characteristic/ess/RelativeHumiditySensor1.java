...
public class RelativeHumiditySensor1 implements ByteArrayInterface, Parcelable {
    ...
    public static final ByteArrayCreater<RelativeHumiditySensor1> CREATOR = new ByteArrayCreater<RelativeHumiditySensor1>() {
        ...
        @Override
        @NonNull
        public RelativeHumiditySensor1 createFromParcel(@NonNull Parcel in) {
            return new RelativeHumiditySensor1(in);
        }
        ...
        @Override
        @NonNull
        public RelativeHumiditySensor1 createFromByteArray(@NonNull byte[] values) {
     ...
     *
     * @param bluetoothGattCharacteristic Characteristics UUID: 0x5213
     */
    public RelativeHumiditySensor1(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private RelativeHumiditySensor1(@NonNull Parcel in) {
    ...
    /**
     * @return Simple threshold [upper limit] 1(%RH)
     */
    public double getSimpleThresholdUpperLimit1Rh() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Simple threshold [upper limit] 2(%RH)
     */
    public double getSimpleThresholdUpperLimit2Rh() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 1(%RH)
     */
    public double getSimpleThresholdLowerLimit1Rh() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Simple threshold [lower limit] 2(%RH)
     */
    public double getSimpleThresholdLowerLimit2Rh() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 1(%RH)
     */
    public double getChangeThresholdRise1Rh() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Change threshold [rise] 2(%RH)
     */
    public double getChangeThresholdRise2Rh() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 1(%RH)
     */
    public double getChangeThresholdDecline1Rh() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_RELATIVE_HUMIDITY_UNIT;
    }
    ...
    /**
     * @return Change threshold [decline] 2(%RH)
     */
