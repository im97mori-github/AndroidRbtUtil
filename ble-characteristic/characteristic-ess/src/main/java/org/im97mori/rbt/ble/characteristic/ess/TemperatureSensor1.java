 ...
 */
public class TemperatureSensor1 implements ByteArrayInterface, Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<TemperatureSensor1> CREATOR = new ByteArrayCreater<TemperatureSensor1>() {
     ...
     */
    public TemperatureSensor1(int eventEnableDisable, int simpleThresholdUpperLimit1, int simpleThresholdUpperLimit2, int simpleThresholdLowerLimit1, int simpleThresholdLowerLimit2, int changeThresholdRise1, int changeThresholdRise2, int changeThresholdDecline1, int changeThresholdDecline2) {
    ...
    public double getSimpleThresholdUpperLimit1DegC() {
        return mSimpleThresholdUpperLimit1 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getSimpleThresholdUpperLimit2DegC() {
        return mSimpleThresholdUpperLimit2 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getSimpleThresholdLowerLimit1DegC() {
        return mSimpleThresholdLowerLimit1 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getSimpleThresholdLowerLimit2DegC() {
        return mSimpleThresholdLowerLimit2 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getChangeThresholdRise1DegC() {
        return mChangeThresholdRise1 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getChangeThresholdRise2DegC() {
        return mChangeThresholdRise2 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getChangeThresholdDecline1DegC() {
        return mChangeThresholdDecline1 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
    ...
    public double getChangeThresholdDecline2DegC() {
        return mChangeThresholdDecline2 * EVENT_THRESHOLD_TEMPERATURE_UNIT;
    }
