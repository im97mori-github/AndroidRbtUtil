...
public class BarometricPressureSensor2 implements ByteArrayInterface, Parcelable {
    ...
    /**
     * @return Average value threshold [upper](hPa)
     */
    public double getAverageValueThresholdUpperHpa() {
        return mAverageValueThresholdUpper * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_1;
    }
    ...
    /**
     * @return Average value threshold [lower](hPa)
     */
    public double getAverageValueThresholdLowerHpa() {
        return mAverageValueThresholdLower * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_1;
    }
    ...
    /**
     * @return Peak to Peak threshold [upper](hPa)
     */
    public double getPeakToPeakThresholdUpperHpa() {
        return mPeakToPeakThresholdUpper * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
    ...
    /**
     * @return Peak to Peak threshold [lower](hPa)
     */
    public double getPeakToPeakThresholdLowerHpa() {
        return mPeakToPeakThresholdLower * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
    ...
    /**
     * @return Interval difference threshold [upper](hPa)
     */
    public double getIntervalDifferenceThresholdUpperHpa() {
        return mIntervalDifferenceThresholdUpper * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
    ...
    /**
     * @return Interval difference threshold [lower](hPa)
     */
    public double getIntervalDifferenceThresholdLowerHpa() {
        return mIntervalDifferenceThresholdLower * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
    ...
    /**
     * @return Base difference threshold [upper](hPa)
     */
    public double getBaseDifferenceThresholdUpperHpa() {
        return mBaseDifferenceThresholdUpper * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
    ...
    /**
     * @return Base difference threshold [lower](hPa)
     */
    public double getBaseDifferenceThresholdLowerHpa() {
        return mBaseDifferenceThresholdLower * EVENT_THRESHOLD_BAROMETRIC_PRESSURE_UNIT_2;
    }
