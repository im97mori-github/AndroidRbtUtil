...
public class SeismicIntensityAcceleration implements ByteArrayInterface, Parcelable {
    ...
    public static final ByteArrayCreater<SeismicIntensityAcceleration> CREATOR = new ByteArrayCreater<SeismicIntensityAcceleration>() {
        ...
        @Override
        @NonNull
        public SeismicIntensityAcceleration createFromParcel(@NonNull Parcel in) {
        ...
        @Override
        @NonNull
        public SeismicIntensityAcceleration createFromByteArray(@NonNull byte[] values) {
     ...
     */
    public SeismicIntensityAcceleration(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private SeismicIntensityAcceleration(@NonNull Parcel in) {
