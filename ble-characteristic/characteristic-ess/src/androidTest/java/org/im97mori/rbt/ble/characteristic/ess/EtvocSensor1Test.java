...
public class EtvocSensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        EtvocSensor1 result = new EtvocSensor1(bluetoothGattCharacteristic);
        ...
        assertEquals(0d, result.getSimpleThresholdUpperLimit1Ppb(), 0);
        assertEquals(0, result.getSimpleThresholdUpperLimit2());
        assertEquals(0d, result.getSimpleThresholdUpperLimit2Ppb(), 0);
        assertEquals(0, result.getSimpleThresholdLowerLimit1());
        assertEquals(0d, result.getSimpleThresholdLowerLimit1Ppb(), 0);
        assertEquals(0, result.getSimpleThresholdLowerLimit2());
        assertEquals(0d, result.getSimpleThresholdLowerLimit2Ppb(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Ppb(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Ppb(), 0);
        assertEquals(0, result.getChangeThresholdDecline1());
        assertEquals(0d, result.getChangeThresholdDecline1Ppb(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2Ppb(), 0);
    }
    ...
    public void test002() {
        ...
        assertEquals(32767d, result.getSimpleThresholdUpperLimit1Ppb(), 0);
        assertEquals(32767, result.getSimpleThresholdUpperLimit2());
        assertEquals(32767d, result.getSimpleThresholdUpperLimit2Ppb(), 0);
        assertEquals(32767, result.getSimpleThresholdLowerLimit1());
        assertEquals(32767d, result.getSimpleThresholdLowerLimit1Ppb(), 0);
        assertEquals(32767, result.getSimpleThresholdLowerLimit2());
        assertEquals(32767d, result.getSimpleThresholdLowerLimit2Ppb(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(10000d, result.getChangeThresholdRise1Ppb(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(10000d, result.getChangeThresholdRise2Ppb(), 0);
        assertEquals(10000, result.getChangeThresholdDecline1());
        assertEquals(10000d, result.getChangeThresholdDecline1Ppb(), 0);
        assertEquals(10000, result.getChangeThresholdDecline2());
        assertEquals(10000d, result.getChangeThresholdDecline2Ppb(), 0);
    }
    ...
    public void test101() {
        ...
        EtvocSensor1 result1 = new EtvocSensor1(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        EtvocSensor1 result2 = EtvocSensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        EtvocSensor1 result1 = new EtvocSensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        EtvocSensor1 result1 = new EtvocSensor1(bluetoothGattCharacteristic);
        EtvocSensor1 result2 = EtvocSensor1.CREATOR.createFromByteArray(data);
