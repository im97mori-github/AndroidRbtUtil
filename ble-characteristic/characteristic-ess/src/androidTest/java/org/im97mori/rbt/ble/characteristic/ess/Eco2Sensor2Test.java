...
public class Eco2Sensor2Test extends AbstractEventEnableDisableTest {
    ...
    public void test104() {
        ...
        Eco2Sensor2 result1 = new Eco2Sensor2(bluetoothGattCharacteristic);
        Eco2Sensor2 result2 = Eco2Sensor2.CREATOR.createFromByteArray(data);
