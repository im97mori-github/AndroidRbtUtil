...
public class BarometricPressureSensor1Test extends AbstractEventEnableDisableTest {
    ...
    public void test001() {
        ...
        data[ 2] = (byte) ((0xb8) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x0b) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0xb8) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x0b) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0xb8) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x0b) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0xb8) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x0b) & 0xff); // Simple threshold [lower limit] 2
        ...
        assertEquals(3000, result.getSimpleThresholdUpperLimit1());
        assertEquals(300.0d, result.getSimpleThresholdUpperLimit1Hpa(), 0);
        assertEquals(3000, result.getSimpleThresholdUpperLimit2());
        assertEquals(300.0d, result.getSimpleThresholdUpperLimit2Hpa(), 0);
        assertEquals(3000, result.getSimpleThresholdLowerLimit1());
        assertEquals(300.0d, result.getSimpleThresholdLowerLimit1Hpa(), 0);
        assertEquals(3000, result.getSimpleThresholdLowerLimit2());
        assertEquals(300.0d, result.getSimpleThresholdLowerLimit2Hpa(), 0);
        assertEquals(0, result.getChangeThresholdRise1());
        assertEquals(0d, result.getChangeThresholdRise1Hpa(), 0);
        assertEquals(0, result.getChangeThresholdRise2());
        assertEquals(0d, result.getChangeThresholdRise2Hpa(), 0);
        assertEquals(0, result.getChangeThresholdDecline1());
        assertEquals(0d, result.getChangeThresholdDecline1Hpa(), 0);
        assertEquals(0, result.getChangeThresholdDecline2());
        assertEquals(0d, result.getChangeThresholdDecline2Hpa(), 0);
    }
    ...
    public void test002() {
        ...
        data[ 2] = (byte) ((0xf8) & 0xff); // Simple threshold [upper limit] 1
        data[ 3] = (byte) ((0x2a) & 0xff); // Simple threshold [upper limit] 1
        data[ 4] = (byte) ((0xf8) & 0xff); // Simple threshold [upper limit] 2
        data[ 5] = (byte) ((0x2a) & 0xff); // Simple threshold [upper limit] 2
        data[ 6] = (byte) ((0xf8) & 0xff); // Simple threshold [lower limit] 1
        data[ 7] = (byte) ((0x2a) & 0xff); // Simple threshold [lower limit] 1
        data[ 8] = (byte) ((0xf8) & 0xff); // Simple threshold [lower limit] 2
        data[ 9] = (byte) ((0x2a) & 0xff); // Simple threshold [lower limit] 2
        ...
        assertEquals(11000, result.getSimpleThresholdUpperLimit1());
        assertEquals(1100.0d, result.getSimpleThresholdUpperLimit1Hpa(), 0);
        assertEquals(11000, result.getSimpleThresholdUpperLimit2());
        assertEquals(1100.0d, result.getSimpleThresholdUpperLimit2Hpa(), 0);
        assertEquals(11000, result.getSimpleThresholdLowerLimit1());
        assertEquals(1100.0d, result.getSimpleThresholdLowerLimit1Hpa(), 0);
        assertEquals(11000, result.getSimpleThresholdLowerLimit2());
        assertEquals(1100.0d, result.getSimpleThresholdLowerLimit2Hpa(), 0);
        assertEquals(10000, result.getChangeThresholdRise1());
        assertEquals(10.000d, result.getChangeThresholdRise1Hpa(), 0);
        assertEquals(10000, result.getChangeThresholdRise2());
        assertEquals(10.000d, result.getChangeThresholdRise2Hpa(), 0);
        assertEquals(10000, result.getChangeThresholdDecline1());
        assertEquals(10.000d, result.getChangeThresholdDecline1Hpa(), 0);
        assertEquals(10000, result.getChangeThresholdDecline2());
        assertEquals(10.000d, result.getChangeThresholdDecline2Hpa(), 0);
    }
    ...
    public void test101() {
        ...
        BarometricPressureSensor1 result2 = BarometricPressureSensor1.CREATOR.createFromParcel(parcel);
    ...
    public void test103() {
        ...
        BarometricPressureSensor1 result1 = new BarometricPressureSensor1(eventEnableDisable, simpleThresholdUpperLimit1, simpleThresholdUpperLimit2, simpleThresholdLowerLimit1, simpleThresholdLowerLimit2, changeThesholdRise1, changeThesholdRise2, changeThesholdDecline1, changeThesholdDecline2);
    ...
    public void test104() {
        ...
        BarometricPressureSensor1 result1 = new BarometricPressureSensor1(bluetoothGattCharacteristic);
        BarometricPressureSensor1 result2 = BarometricPressureSensor1.CREATOR.createFromByteArray(data);
