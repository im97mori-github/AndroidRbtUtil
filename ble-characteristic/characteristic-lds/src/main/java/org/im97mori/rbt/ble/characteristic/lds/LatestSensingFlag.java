 ...
 */
public class LatestSensingFlag implements ByteArrayInterface, Parcelable {
    ...
    public LatestSensingFlag(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        mAmbientLightFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 5);
        mBarometricPressureFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 7);
        mSoundNoiseFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 9);
        mEtvocFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 11);
        mEco2Flag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 13);
    }
