...
public class MemoryCalculationFlag implements ByteArrayInterface, Parcelable {
    ...
    public MemoryCalculationFlag(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        mSiValueFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 8);
        mPgaFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 9);
        mSeismicIntensityFlag = bluetoothGattCharacteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 10);
    }
