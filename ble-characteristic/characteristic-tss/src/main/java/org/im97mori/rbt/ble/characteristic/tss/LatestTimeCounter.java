...
public class LatestTimeCounter implements ByteArrayInterface, Parcelable {
    ...
    public LatestTimeCounter(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        mTimeCounter = RbtUtils.createBigInteger(bluetoothGattCharacteristic.getValue(), 0, 8);
    }
