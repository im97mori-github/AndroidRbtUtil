...
import static org.im97mori.rbt.ble.characteristic.is.FlashMemoryStatus.FLASH_MEMORY_STATUS_FLASH_MEMORY_ERASING;
import static org.im97mori.rbt.ble.characteristic.is.FlashMemoryStatus.FLASH_MEMORY_STATUS_NONE;
import static org.im97mori.rbt.ble.characteristic.is.FlashMemoryStatus.FLASH_MEMORY_STATUS_WRITE_SUCCESS;
import static org.im97mori.rbt.ble.characteristic.is.FlashMemoryStatus.FLASH_MEMORY_STATUS_WRITING;
...
public class RbtWriteCharacteristicTask extends AbstractRbtTask {
     ...
     */
    public RbtWriteCharacteristicTask(@NonNull BLEConnection bleConnection
            ...
            if (INFORMATION_SERVICE.equals(serviceUUID) && FLASH_MEMORY_STATUS_CHARACTERISTIC.equals(characteristicUUID)) {
                ...
                if (PROGRESS_CHARACTERISTIC_READ_SUCCESS == nextProgress) {
                    ...
                    if (mWaitTarget == flashMemoryStatus || mWaitTarget == FLASH_MEMORY_STATUS_FLASH_MEMORY_ERASING && FLASH_MEMORY_STATUS_WRITE_SUCCESS == flashMemoryStatus) {
                        ...
                        mTaskHandler.sendProcessingMessage(WriteCharacteristicTask.createWriteCharacteristicSuccessMessage(mServiceUUID, mCharacteristicUUID, mByteArrayInterface.getBytes()), DateUtils.SECOND_IN_MILLIS * 5);
                        ...
                        mBLEConnection.getBLECallback().onCharacteristicWriteSuccess(getTaskId(), mBluetoothGatt.getDevice(), mServiceUUID, mCharacteristicUUID, mByteArrayInterface.getBytes(), mArguemnt);
